...
export default function Home() {
  ...
  async function handleAnalyze() {
    ...
    setError(null);
    try {
      const res = await fetch(`/api/analyze?ticker=${encodeURIComponent(symbol)}&useAi=${useAi}`);
                ...
                <div>
                  <div className="mb-2 flex items-center justify-between">
                    ...
                    <span
                      ...
                      title={
                        result.usedAi
                          ? "Generated by the OpenRouter AI model"
                          : "OPENROUTER_API_KEY is missing, invalid, or the API call failed — showing the rule-based fallback instead"
                      }
                    >
                      {result.usedAi ? "AI-generated" : "Rule-based fallback"}
                    </span>
                  </div>
